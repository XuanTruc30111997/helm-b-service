...
* **Build Docker** docker build -t practice-helm/b-service:1.3.6 .
* **Tag Image** docker tag practice-helm/b-service:1.3.6 <repo>/helm-b-service:1.3.6
* **Push Image** docker push <repo>/helm-b-service:1.3.6
