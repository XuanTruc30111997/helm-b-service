...
* **Build Docker** docker build -t practice-helm/b-service:1.5.1 .
* **Tag Image** docker tag practice-helm/b-service:1.5.1 <repo>/helm-b-service:1.5.1
* **Push Image** docker push <repo>/helm-b-service:1.5.1
